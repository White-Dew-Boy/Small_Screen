...
lv_obj_t *ui_mqtt_pub_create(void)
{
    ...
    lv_obj_align(s_count_label, LV_ALIGN_TOP_MID, 0, 28);
    ...
    lv_obj_align(tel_hdr, LV_ALIGN_TOP_LEFT, 12, 54);
    s_tel_topic_label = make_topic_label(scr, 72);
    ...
    lv_obj_align(status_hdr, LV_ALIGN_TOP_LEFT, 12, 96);
    s_status_topic_label = make_topic_label(scr, 114);
    ...
    lv_obj_align(rsp_hdr, LV_ALIGN_TOP_LEFT, 12, 138);
    s_rsp_topic_label = make_topic_label(scr, 156);
