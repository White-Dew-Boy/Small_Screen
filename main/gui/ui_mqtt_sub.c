...
lv_obj_t *ui_mqtt_sub_create(void)
{
    ...
    lv_obj_align(cmd_hdr, LV_ALIGN_TOP_LEFT, 12, 40);
    ...
    lv_obj_set_width(s_cmd_topic_label, 216);
    lv_obj_align(s_cmd_topic_label, LV_ALIGN_TOP_LEFT, 12, 58);
    ...
    lv_obj_align(help_hdr, LV_ALIGN_TOP_LEFT, 12, 92);
    ...
    lv_obj_align(note, LV_ALIGN_TOP_LEFT, 12, 176);
